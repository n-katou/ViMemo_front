...
const PlaylistSidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <div
        className={`
        fixed top-0 left-0 h-full w-full sm:w-1/3 md:w-1/4 bg-gray-50 p-4 pt-16 border-r z-40
        transform transition-transform duration-300 ease-in-out
        ${showSidebar ? "translate-x-0" : "-translate-x-full"}
      `}
      >
        <h2 className="text-xl font-bold mt-8 mb-4" style={{ color: '#38bdf8' }}>プレイリスト</h2>
